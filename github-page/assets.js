  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'C:/git/IBL-Baker-Online/cmake-build-release-emscripten/App/dist/assets.data';
...
Module['FS_createPath']("/assets", "rosendal_plains_2_1k", true, true);
...
Module['FS_createPath']("/assets", "unpacked", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_C:/git/IBL-Baker-Online/cmake-build-release-emscripten/App/dist/assets.data');

      };
      Module['addRunDependency']('datafile_C:/git/IBL-Baker-Online/cmake-build-release-emscripten/App/dist/assets.data');
